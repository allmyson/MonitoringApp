...
public class TtzJLFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {

    public static TtzJLFragment newInstance() {
        TtzJLFragment ttzJLFragment = new TtzJLFragment();
        return ttzJLFragment;
    }
