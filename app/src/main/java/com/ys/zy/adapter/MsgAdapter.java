...
public class MsgAdapter extends CommonAdapter<MsgBean.DataBean> {
    public MsgAdapter(Context context, List<MsgBean.DataBean> mDatas, int itemLayoutId) {
        super(context, mDatas, itemLayoutId);
    }

    @Override
    public void convert(ViewHolder helper, MsgBean.DataBean item, int position) {
