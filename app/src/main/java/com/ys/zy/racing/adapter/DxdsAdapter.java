...
public class DxdsAdapter extends CommonAdapter<String> {
    private List<List<Boolean>> list;
    private int numberSize = 4;
    private DwdAdapter.ChangeListener changeListener;
    ...
    public DxdsAdapter(Context context, List<String> mDatas, int itemLayoutId) {
    ...
    public DwdAdapter.ChangeListener getChangeListener() {
        return changeListener;
    }

    public void setChangeListener(DwdAdapter.ChangeListener changeListener) {
