...
import com.ys.monitor.chat.adapter.EmotionGridViewAdapter;
import com.ys.monitor.chat.adapter.EmotionPagerAdapter;
import com.ys.monitor.chat.base.BaseFragment;
import com.ys.monitor.chat.util.EmotionUtils;
import com.ys.monitor.chat.util.GlobalOnItemClickManagerUtils;
import com.ys.monitor.chat.util.Utils;
import com.ys.monitor.chat.widget.IndicatorView;
...
public class ChatEmotionFragment extends BaseFragment {
    ...
    private void initEmotion() {
        ...
        if(EmotionUtils.EMOTION_STATIC_MAP.isEmpty()){
            return;
        }
        // 遍历所有的表情的key
