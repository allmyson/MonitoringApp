...
public class ArcGisZoomView extends LinearLayout {
    ...
    private void initAttr(TypedArray ta) {
        bgColor = ta.getResourceId(R.styleable.ViewAttr_view_background,
                R.drawable.sddman_shadow_bg);
        zoomWidth = ta.getDimensionPixelSize(R.styleable.ViewAttr_button_width,
                Util.valueToSp(getContext(), 35));
        zoomHeight = ta.getDimensionPixelSize(R.styleable.ViewAttr_button_height,
                Util.valueToSp(getContext(), 35));
        ...
        zoomInImage = ta.getResourceId(R.styleable.ViewAttr_zoom_in_image,
                R.drawable.sddman_zoomin);
        zoomOutImage = ta.getResourceId(R.styleable.ViewAttr_zoom_out_image,
                R.drawable.sddman_zoomout);
    ...
    private OnClickListener listener = new OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            Log.e("lh", "scale=" + scale);
            if (Double.isNaN(scale)) {
                Toast.makeText(getContext(), "未获取到当前地图缩放比例", Toast.LENGTH_SHORT).show();
                return;
            }
    ...
    private void setZoomDpWidth(int w) {
        ...
        LinearLayout.LayoutParams linearParams =
                (LinearLayout.LayoutParams) spiltLineView.getLayoutParams();
    ...
    private void setZoomDpHeight(int h) {
        ...
        LinearLayout.LayoutParams linearParams =
                (LinearLayout.LayoutParams) spiltLineView2.getLayoutParams();
